class AdvertismentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @advertisment.save
        ...
        format.json { render action: 'show', status: :created, location: @advertisment }
      else
  ...
  private
    ...
    def advertisment_params
      params.require(:advertisment).permit(:title, :description, :expire, :job_type, :number_of_positions, :reciving_email, :category, :location, :employer_id)
    end
end
